...
- **Calibrated labor absorption.** Preset pass-through values are selected to reproduce the paper's 2030 aggregate unemployment rates. They summarize demand growth and jobs created elsewhere, but are not direct empirical estimates and should not be interpreted as stable historical relationships.
