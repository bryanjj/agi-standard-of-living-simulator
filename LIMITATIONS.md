...
- **Simplified current law.** Tax and benefit rules are transparent proxies, not a CBO or PolicyEngine microsimulation. Program eligibility, duration, Social Security, Medicare, Medicaid, and state taxes are not modeled individually.
- **Investment holdings are a proxy.** The household's reported investments determine its capital-income claim. Asset type, pension wealth, private business equity, leverage, and returns are not separated.
- **Two goods only.** Housing and other scarce goods are grouped together; all other consumption is treated as reproducible. Sector-specific healthcare, food, energy, and construction assumptions are intentionally omitted.
- **Fixed household.** Household size and housing status do not change over the simulation.
- **Quintile presets mix survey vintages.** Income is from Census 2024; financial assets and inferred traits are from the 2022 SCF and remain in 2022 dollars. A preset describes group means, not a representative individual family.
