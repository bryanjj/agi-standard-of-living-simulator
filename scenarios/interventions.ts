...
export const interventions: Record<InterventionId, PolicyIntervention> = {
  'status-quo': {
    ...
    description: 'Temporary unemployment insurance follows current national averages. New AI capital income follows today’s holdings.',
    laborLossReplacement: calibration.longRunLaborLossReplacement.value, equalDividendShare: 0,
  },
  'safety-net': {
  ...
  'citizen-dividend': {
    ...
    laborLossReplacement: calibration.longRunLaborLossReplacement.value, equalDividendShare: calibration.citizenDividendShare.value,
  },
  'public-fund': {
    ...
    laborLossReplacement: calibration.longRunLaborLossReplacement.value, equalDividendShare: calibration.publicFundDividendShare.value,
  },
};
